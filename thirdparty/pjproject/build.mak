export PJDIR := /home/gerrit/godot/thirdparty/pjproject
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lopus -lssl -lcrypto -luuid -lm -lrt -lpthread  -lasound -L/usr/lib -lSDL2  -lavdevice -lavformat -lavcodec -lswscale -lavutil -lv4l2 -lopencore-amrnb -lopencore-amrwb
